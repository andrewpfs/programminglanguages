error id: file:///C:/Users/andre/projects/uhcs/ha_uyenco/assign2/scala/fib-app/src/main/scala/fib-app/fibonacciAppRecursiveAndIterative.scala:`<none>`.
...
object FibonacciAppRecursiveAndIterative {
  def fibonacciSeriesRecursiveAndIterative(position : Int): List[Int] = position match {
    ...
    case _ => 
      for (i <- 2 to position){
          val prevSeries = fibonacciSeriesRecursiveAndIterative(position - 1)
           :+ se@@ries.takeRight(2).sum
      }
  } 
  series
}
